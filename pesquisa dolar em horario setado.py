...
Set_Alarm2 = input("Entre com o 2º horário do IMPLEMENTATION H:M:S:")
Set_Alarm3 = input("Entre com o 3º horário do VERIFICATION H:M:S:")
Set_Alarm4 = input("Entre com o 4º horário do MONITORING H:M:S:")
Set_Alarm5 = input("Entre com o 5º horário do COMPLETE H:M:S:")
